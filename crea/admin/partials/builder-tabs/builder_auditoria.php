...
// Nomenclatura Uniforme de Acciones
$action_labels = [
    'create'      => '<span class="dashicons dashicons-database" style="color:var(--crea-primary);"></span> Creación de Base',
    'update_meta' => '<span class="dashicons dashicons-edit" style="color:var(--crea-warning);"></span> Edición de Base',
    'delete'      => '<span class="dashicons dashicons-trash" style="color:var(--crea-danger);"></span> Eliminación de Base',
    'add_col'     => '<span class="dashicons dashicons-plus-alt2" style="color:#16A34A;"></span> Creación de Variable',
    'edit_col'    => '<span class="dashicons dashicons-admin-generic" style="color:var(--crea-warning);"></span> Edición de Variable',
    'delete_col'  => '<span class="dashicons dashicons-trash" style="color:var(--crea-danger);"></span> Eliminación de Variable', // Añadido para el evento de borrado
];
                ...
                <div style="flex: 1; min-width: 150px;">
                    ...
                    <select name="filter_action" style="width: 100%;">
                        ...
                        <optgroup label="Bases de Datos">
                            <option value="create" <?php selected($filter_action, 'create'); ?>>Creación de Base</option>
                            <option value="update_meta" <?php selected($filter_action, 'update_meta'); ?>>Edición de Base</option>
                            <option value="delete" <?php selected($filter_action, 'delete'); ?>>Eliminación de Base</option>
                        </optgroup>
                        <optgroup label="Estructura (Variables)">
                            <option value="add_col" <?php selected($filter_action, 'add_col'); ?>>Creación de Variable</option>
                            <option value="edit_col" <?php selected($filter_action, 'edit_col'); ?>>Edición de Variable</option>
                            <option value="delete_col" <?php selected($filter_action, 'delete_col'); ?>>Eliminación de Variable</option>
                        </optgroup>
                    </select>
                </div>
